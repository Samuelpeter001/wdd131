...
const temples = [
	...
	temples.forEach(temple => {
		const tempcreate = document.createElement('div');
		tempcreate.className = 'temple-design';
			tempcreate.innerHTML = `
		...
		`;
		frame.appendChild(tempcreate);
	});
	oldTemples(temples);
	const filters = document.querySelector("#old");
